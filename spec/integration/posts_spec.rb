...
RSpec.describe 'Post testing', type: :feature do
  ...
  describe 'show page' do
    before(:example) do
      @user1 = User.create(name: 'Abeera', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Developer',
                           posts_counter: 1)
      @user2 = User.create(name: 'Zia', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Engineer',
                           posts_counter: 1)
